    ...
    <section id="data_container clearfix">
    	<div class="wrapper-910">
        	<div class="header-wrap">
            	<h2 class="page-header">All Pending Assignments</h2>               
         </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var oTable = $('#example').dataTable({
                ...
                "aoColumnDefs": [
                    {"bSortable": false, "aTargets": [0,4,5,7]}
                ],
            ...
            <div id="users_list_div">
                <table  class="display" id="example">
                    ...
                    <tbody>   
                       <?php 
/*						    echo "<pre>";
							print_r($allPendingAssignments);  */ 
							$i = 1; 			
							foreach($allPendingAssignments as $assignment):
							if($i%2==0)
							 $class = 'even';
							else
							  $class = 'odd';
						?>
						  <tr class="even_gradeC <?php echo $class; ?>">
							  <td align="center"><input type="checkbox" value="<?php echo $assignment['service_hours_id']; ?>" name="check17"></td>
							  <td valign="middle"><a href="studentinfo/<?php echo $assignment['student_id']; ?>" class="fancybox fancybox.ajax"><?php echo $assignment['firstname']." ".$assignment['lastname']; ?></a></td> 
                              <td valign="middle"><?php echo $assignment['email']; ?></td>
							  <td valign="middle"><?php echo $assignment['organization_event']; ?></td>
							  <td valign="middle"><?php echo date("m/d/Y", strtotime(@$assignment['from_date']))." - ".date("m/d/Y", strtotime(@$assignment['to_date'])); ?></td>
							  <td valign="middle"><?php echo $assignment['hours'].":".$assignment['minutes']; ?></td>	
							  <td valign="middle"><?php if(@$assignment['document']!='') { echo "Yes"; } else { echo "No"; } ?></td>					
							  <td><a href="<?php echo BASE_FRONTEND_URL; ?>assignments/viewAssignment/<?php echo $assignment['service_hours_id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Approve"></a></td>
							</tr>
						<?php endforeach; ?>       
                    </tbody>
                </table>
