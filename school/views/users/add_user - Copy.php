...
<form action="<?php if(count(@$userDetails) > 0){ echo BASE_FRONTEND_URL.'users/editUser'; } else{ echo BASE_FRONTEND_URL.'users/add'; } ?>" enctype="multipart/form-data" name="form_users"  id="form_users" method="post">    
<div id="prowrap">
      <div class="clear"></div>
      <div class="clear"></div>
      <div class="clear"></div>
        ...
        <div id="poprightcol">
         ...
         <div class="poprightform form_cont_full">
          ...
          <div class="poprightform form_cont_full">
            ...
            <br>
            <br>
            <input type="file" id="file" name="file" tabindex="12"><?php if(@$userDetails[0]['picture']!='') { ?><img src="<?php echo BASE_FRONTEND_URL."/".@$userDetails[0]['picture']; ?>" width="50"><?php } ?>
          </div>     
...
<?php if(@$userDetails[0]['city_id'] > 0) { ?>
getCitiesUsers(<?php echo @$userDetails[0]['state_id']; ?>,<?php echo @$userDetails[0]['city_id']; ?>);
<?php } ?>
