    ...
    <section id="data_container clearfix">
    	<div class="wrapper-910">
        	<div class="header-wrap">
            	<h2 class="page-header">list of all users</h2>               
         </div>
...
<!-- Data Tables end - html -->
 ...
 <div class="wrapper-910">     
            ...
            <div class="table-buttons">
            	<a href="<?php echo BASE_FRONTEND_URL; ?>users/add" class="fancybox fancybox.ajax"><input type="button" value="Add User" class="btn-input btn-add-establisment"></a>
                       ...
                       <?php 
						...
						?>
						  <tr class="even_gradeC <?php echo $class; ?>">
							  ...
							  <td><a href="<?php echo BASE_FRONTEND_URL; ?>users/editUser/<?php echo $user['user_id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Edit"></a></td>
							</tr>
						<?php endforeach; ?>       
                    </tbody>
                </table>
