    ...
    <section id="data_container clearfix">
    	<div class="wrapper-910">
        	<div class="header-wrap">
            	<h2 class="page-header">list of all organizations</h2>               
            <?php
/*			echo "<pre>";
			print_r($_REQUEST);*/
			?>            
...
<!-- Data Tables end - html -->
 ...
 <div class="wrapper-910">     
            ...
            <div class="table-buttons">
            	<a href="<?php echo BASE_FRONTEND_URL; ?>organizations/add" class="fancybox fancybox.ajax"><input type="button" value="Add Organization" class="btn-input btn-add-establisment"></a>
                       ...
                       <?php 
						...
						?>
						  <tr class="even_gradeC <?php echo $class; ?>">
							  <td align="center"><input type="checkbox" value="<?php echo $organization['organization_id']; ?>" name="check17"></td>			 
                              <td valign="middle"><?php echo $organization['organization_name']; ?></td>
                              <td valign="middle"><?php echo $organization['email']; ?></td>
							  <td valign="middle"><?php echo $organization['phone']; ?></td>
							  <td valign="middle"><?php echo $organization['city']; ?></td>
							  <td valign="middle"><?php echo $organization['state']; ?></td>	
							  <td valign="middle"><?php echo $organization['organization_status']; ?></td>					
							  <td><a href="<?php echo BASE_FRONTEND_URL; ?>organizations/editOrganization/<?php echo $organization['organization_id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Edit"></a></td>
							</tr>
						<?php endforeach; ?>       
                    </tbody>
                </table>
