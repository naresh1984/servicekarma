        ...
        $(document).ready(function() {
            ...
            var oTable = $('#example').dataTable({
                ...
                "bFilter"
                        : true,
                "aoColumnDefs": [
                    {"bSortable": false, "aTargets": [0,6,9]}
                ],
                ...
                "bAutoWidth"
                        : true}).
                    columnFilter();
            $("#divRefresh").html('<input type="button" classs="btn-table" value="Export" id="btn1"/><input type="button" value="Print" id="btn2" classs="btn-table"><input type="button" value="Hide Filter" id="btn3" classs="btn-table"><input type="button" value="Add Establisment" id="btn4" classs="btn-table" /><input type="button" value="icon_Add Event" id="btn5" classs="btn-table" />');
...
<!-- Data Tables end - html -->
 ...
 <div class="wrapper-910">     
            ...
            <div class="table-buttons">
            	<a href="<?php echo BASE_FRONTEND_URL; ?>events/add" class="fancybox fancybox.ajax"><input type="button" value="Add Event" class="btn-input btn-add-establisment"></a>
                       ...
                       <?php 
						...
						?>
						  <tr class="even_gradeC <?php echo $class; ?>">
							  <td align="center"><input type="checkbox" value="<?php echo $event['event_id']; ?>" name="check17"></td>			 
                              <td valign="middle"><?php echo $event['event_title']; ?></td>
                              <td valign="middle"><?php echo $event['organization_name']; ?></td>
                              <td valign="middle"><?php echo $event['category_name']; ?></td>
                              <td valign="middle"><?php echo $event['city']; ?></td>
							  <td valign="middle"><?php echo $event['state']; ?></td>
							  <td valign="middle"><?php echo date("m/d/Y", strtotime(@$event['from_date']))." - ".date("m/d/Y", strtotime(@$event['to_date'])); ?></td>
							  <td valign="middle"><?php //echo strtotime(@$event['to_date'])."-".strtotime(date("Y-m-d")); 
							  ...
							  ?></td>	
							  <td valign="middle"><?php echo $event['event_status']; ?></td>					
							  <td><a href="<?php echo BASE_FRONTEND_URL; ?>events/editEvent/<?php echo $event['event_id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Edit"></a></td>
							</tr>
						<?php endforeach; ?>       
                    </tbody>
                </table>
