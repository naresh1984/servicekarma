...
<!-- Data Tables end - html -->
 ...
 <div class="wrapper-910">     
            ...
            <div class="table-buttons">
            	<a href="<?php echo BASE_FRONTEND_URL; ?>categories/add" class="fancybox fancybox.ajax"><input type="button" value="Add Category" class="btn-input btn-add-establisment"></a>
                       ...
                       <?php 
						...
						?>
						  <tr class="even_gradeC <?php echo $class; ?>">
							  <td align="center"><input type="checkbox" value="<?php echo $category['id']; ?>" name="check17"></td>
							  <td valign="middle"><?php echo $category['category_name']; ?></td>	
							  <td valign="middle"><?php echo $category['status']; ?></td>					
							  <td><a href="<?php echo BASE_FRONTEND_URL; ?>categories/editCategory/<?php echo $category['id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Edit"></a></td>
							</tr>
						<?php endforeach; ?>       
                    </tbody>
                </table>             
