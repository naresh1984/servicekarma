...
<div class="login_inner">
  <div class="login_inline">
    <div class="form_cont_full pro_window_header clearfix">
      <h4><?php if(count(@$estDetails) > 0){ echo 'Edit';}else{ echo 'Add'; } ?> Establishment Settings</h4>
      <div class="clear"></div>
    </div>
     
<form action="<?php echo BASE_FRONTEND_URL;?>profiles/editEst" enctype="multipart/form-data" name="form_est"  id="form_est" method="post">    
<div id="prowrap">
      <div class="clear"></div>
      <div class="clear"></div>
      <div class="clear"></div>
      ...
      <div id="popwrap">
        <div id="popleftcol">
          ...
          <div class="popleftform form_cont_full">
            ...
            <br>
            <br>
            <input type="file" id="file" name="file" tabindex="12"><?php if(@$estDetails[0]['picture']!='') { ?><img src="../../admin/<?php echo @$estDetails[0]['picture']; ?>" width="50"><?php } ?>
          </div> 
        </div>
        ...
        <div id="poprightcol">
          ...
          <div class="poprightform form_cont_full" id="prorate_hours">
            <br>
            <br>
          
            <label style="width:60%">Required Hours For:</label>
            <br>
            <br>
            
              <?php
			  foreach(range(1, $estDetails[0]['graduation_years']) as $number):
			  ?>
              <?php echo $number.' Year'; if($number > 1){ echo 's '; }else{ echo '&nbsp;&nbsp;&nbsp;'; }?>: <input type="text" name="required_hours[]" id="require_<?php echo $number; ?>" class="years_class"  value="<?php echo @$estDetails[0]['required_hours'][$number-1]['required_hours']; ?>" style="width:75%">
               <br>
            <br>
              <?php
			  endforeach;
      ...
      <input type="hidden" name="image_url" id="image_url" value="../../admin/<?php echo @$estDetails[0]['picture']; ?>">
...
<?php
	foreach(range(1, $estDetails[0]['graduation_years']) as $number):
?>
$('#require_<?php echo $number; ?>').mask('000');
<?php
	 endforeach;
?>
