...
<div style="display: block;" id="sc1" class="tabcontent">
  <section class="por_contentainer clearfix">
    ...
    <img src="<?php echo BASE_FRONTEND_URL.$profile[0]['picture']; ?>" alt="Profile Preview" width="172" >
    <?php }else{ ?>
    ...
    <section class="por_content">
      ...
      <div class="por_content_inner">
        ...
        <div class="clear"></div>
        <div class="button-pro clearfix"> <br>
        <a href="<?php echo BASE_FRONTEND_URL; ?>profiles/editProfile" class="fancybox fancybox.ajax"><button class="button button-bluenew btn-two-half">Edit Profile</button></a> 
          <br> <br>
          <a href="<?php echo BASE_FRONTEND_URL; ?>profiles/changepassword" class="fancybox fancybox.ajax"><button class="button button-bluenew btn-two-half">Change Password</button></a></div>
      </div>
    </section>
  </section>
</div>
