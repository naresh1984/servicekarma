...
<div class="gridContainer clearfix">
 ...
 <div id="main">   
    <nav>
        ...
        <a href="manage_organizations.php"  class="active" >Organizations</a>
        ...
        <section class="table-topbar">
        	...
        	<div class="wrapper-910">
            	<div class="table-buttons">
                     ...
                     <a href="add_organization.php" class="fancybox fancybox.ajax"><input type="button" value="Add Organization" class="btn-input btn-add-organization"></a>
        ...
        <section class="wrapper-910 clearfix">        
            ...
            <tbody>
                ...
                <tr class="even_gradeC">
                  ...
                  <td valign="middle"><span class="read_only">Red Cross</span></td> 
                  <td valign="middle" class="center">Address1</td>
                  <td>800-123-4567</td>                       
                  <td><a href="edit_organization.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>            
                </tr>
                ...
                <tr class="odd_gradeX" id="2">
                  <td align="center"><input type="checkbox" value="5" name="check5"></td>
                    <td valign="middle" class="read_only">Invington</td>                  
                    <td valign="middle" class="center">Address1</td>
