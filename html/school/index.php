...
<div class="gridContainer clearfix">
 ...
 <div id="excol-wrap">       
<!--<div class="eg-bar"><span id="faq1-title" class="iconspan"><img src="img/collapse.png" /></span>Irvington High</div>-->
<div id="faq1" class="icongroup1">


<ul id="tablist">
<li><a href="#" class="current" onClick="return expandcontent('sc1', this)">All</a></li>
<li><a href="#" onClick="return expandcontent('sc2', this)">With Document</a></li>
<li><a href="#" onClick="return expandcontent('sc3', this)">Without Document</a></li>
...
<div id="all_document" class="pending-services-content">
                ...
                <div class="wrapper-910">
                  ...
                  <span class="items">Items 1-6 of 6</span> </div>
...
<table  id="example"  class="display">
                ...
                <tbody>
                    ...
                    <tr class="odd_gradeX" id="filter">
                        ...
                        <td class="read_only"><a href="student_profile.php" class="fancybox fancybox.ajax">John Smith</a></td>
                        <td>Red Cross</td>
                        <td>Humanitarian</td>
                        <td class="center">9/5/13 - 9/10/13</td>
...
faq.setHeader('<img src="img/collapse.png" />', '<img src="img/expand.png" />') //set icon HTML
