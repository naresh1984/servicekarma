...
<div id="prowrap">
            ...
            <div class="clear"></div>
                ...
                <div id="poppro">
                <div id="center"><img src="img/icon_profile-preview-small.png"></div>
				<div class="clear"></div>
                <br>
                Irvington High<br>
                A10045678<br>
...
408-727-1100
 ...
 <!--            	<button class="button button-darkgray btn-two-half left">View Full profile</button>
                <button class="button button-bluenew btn-two-half left">close</button>-->
                <button class="button button-darkgray btn-two-half left" onClick="window.location.href='manage_user-details.php'">View Full profile</button>
