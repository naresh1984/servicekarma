...
<div class="gridContainer clearfix">
 ...
 <div id="main">   
    <nav>
        ...
        <a href="manage_users.php">Students</a>
    ...
    <section id="data_container clearfix">
        ...
        <section class="table-topbar">
        	...
        	<div class="wrapper-910">
            	<div class="table-buttons">
                  <a href="add_event.php" class="fancybox fancybox.ajax"><input type="button" value="Add Event" class="btn-input btn-add-addevent"></a>
        ...
        <section class="wrapper-910 clearfix">        
        	...
        	<table  id="example"  class="display" style="text-align:left">
                ...
                <th width="10%">Type of event</th>
                <th width="19%">Date Range</th>
                <th width="15%">Past/Future Event</th>
                <th width="16%">No. of Volunteers</th>
            ...
            <tbody>
                ...
                <tr class="even_gradeC">
                  ...
                  <td valign="middle" class="center">09/20/2014 - 09/22/2014</td>
                  <td>Future event</td>
                  <td>100</td>
                  <td><a href="edit_event.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>
                </tr>
                <tr class="even_gradeX" id="4">
                  <td align="center"><input type="checkbox" value="2" name="check2"></td>
                    ...
                    <td valign="middle" class="center">09/19/2014 - 09/22/2014</td>
                    <td>Future event</td>
                    <td>200</td>
                    <td><a href="#" class="noti_icons"><img src="img/edit_event.png" width="20"></a></td>
                </tr>
                <tr class="odd_gradeC" id="2">
                  <td align="center"><input type="checkbox" value="5" name="check5"></td>
                    ...
                    <td valign="middle" class="center">Humanitarian</td>
                    <td valign="middle" class="center">09/15/2014 - 09/19/2014</td>
