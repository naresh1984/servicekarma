...
<div id="prowrap">
            ...
            <div class="clear"></div>
            	<div id="popwrap">
					...
					<input name="" type="text" placeholder="09-13-2014" style="background:url(img/icon_calendar.png) right no-repeat; ">
                    </div>
              ...
              <select name="" style="width:30%">
                ...
                <option>Select State</option>
                    ...
                    <label>To Date:</label>
                    <br><br>
					<input name="" type="text" placeholder="09-22-2014"  style="background:url(img/icon_calendar.png) right no-repeat; ">
                    </div>
                    <div class="poprightform form_cont_full">
