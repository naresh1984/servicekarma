...
<!--              <div class="form_cont_half">
                    <label class="lableselect">Select organization/establishment</label>
        ...
        <section class="table-topbar">
        	...
        	<div class="wrapper-910">
            	<div class="table-buttons">
            	  <select name="" class="btn-select btn-add-adduser">
        ...
        <section class="wrapper-910 clearfix">        
            ...
            <tbody>
                ...
                <tr class="even_gradeC">
                  ...
                  <td valign="middle"><span class="read_only"><a href="student_profile.php" class="fancybox fancybox.ajax">John Smith</a></span></td>
                  <td valign="middle">1234521</td>
                  <td valign="middle" class="center">9</td>
                ...
                <tr class="odd_gradeX" id="2">
                  <td align="center"><input type="checkbox" value="5" name="check5"></td>
                    ...
                    <td valign="middle" class="even_gradeC">1234572</td>
                    <td valign="middle" class="center">10</td>
                    <td valign="middle" class="center">john.deo@hotmail.com</td>
                ...
                <tr class="even_gradeC" id="4">
                  <td align="center"><input type="checkbox" value="6" name="check6"></td>
                    <td valign="middle">Scott Lewis</td>
                    <td valign="middle">1234568</td>
                    <td valign="middle" class="center">11</td>
                    <td valign="middle" class="center">scottlewis@hotmail.com</td>
                    <td>800-123-4567</td>
                </tr>
                <tr class="even_gradeC" id="4">
                ...
                <tr class="even_gradeC" id="4">
                  <td align="center"><input type="checkbox" value="6" name="check6"></td>
                    <td valign="middle">Scott Lewis</td>
                    <td valign="middle">1234560</td>
                    <td valign="middle" class="center">12</td>
                    <td valign="middle" class="center">scottlewis@hotmail.com</td>
                    <td>800-123-4567</td>
                </tr>
              </tbody>
