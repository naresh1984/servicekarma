...
<div class="gridContainer clearfix">
 ...
 <div id="main">   
    <nav>
        ...
        <a href="manage_categories.php" class="right_border active">Categories</a>
    </nav>
    </nav>
        ...
        <section class="table-topbar">
        	...
        	<div class="wrapper-910">
            	<div class="table-buttons">
                     ...
                     <a href="add_category.php" class="fancybox fancybox.ajax"><input type="button" value="Add Category" class="btn-input btn-add-organization"></a>
        ...
        <section class="wrapper-910 clearfix">        
            ...
            <tbody>
                ...
                <tr class="even_gradeC">
                  ...
                  <td valign="middle"><span class="read_only">Health</span></td> 
                  <td valign="middle" class="center">Active</td>                                        
                  <td><a href="edit_category.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>            
                </tr>
                <tr class="even_gradeX">
                  <td align="center"><input type="checkbox" value="2" name="check17"></td>
                  <td valign="middle"><span class="read_only">Education</span></td> 
                  <td valign="middle" class="center">Active</td>                                        
                  <td><a href="edit_category.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>            
                </tr>
                <tr class="even_gradeC">
                  <td align="center"><input type="checkbox" value="2" name="check17"></td>
                  <td valign="middle"><span class="read_only">Social</span></td> 
                  <td valign="middle" class="center">Active</td>                                        
                  <td><a href="edit_category.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>            
                </tr>
                <tr class="even_gradeX">
                  <td align="center"><input type="checkbox" value="2" name="check17"></td>
                  <td valign="middle"><span class="read_only">Other</span></td> 
                  <td valign="middle" class="center">Active</td>                                        
                  <td><a href="edit_category.php" class="fancybox fancybox.ajax"><img src="img/edit_event.png" width="20"></a></td>            
                </tr>
              </tbody>
