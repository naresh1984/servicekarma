...
gsBottom="<A id='bottomAnchor' href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();fOnSelectMon();return false;' onmouseover='return true;' ></A>";
