...
// you may have sophisticated holiday calculation set here, following are only simple examples.
	if (m==1&&d==1&&y==2014)
		r=[" Jan 1, "+y+" \n Happy New Year! ",gsAction,"skyblue","red"];
	else if (m==1&&d==14&&y==2014)
		r=[" Jan 14, "+y+" \n Sankranthi! ",gsAction,"skyblue","red"];
	else if (m==3&&d==31&&y==2014)
		r=[" Mar 31, "+y+" \n Ugadi! ",gsAction,"skyblue","red"];
	else if (m==7&&d==29&&y==2014)
		r=[" Jul 29, "+y+" \n Ramzan! ",gsAction,"skyblue","red"];
	else if (m==8&&d==15&&y==2014)
		r=[" Aug 15, "+y+" \n Independence day! ",gsAction,"skyblue","red"];
	else if (m==8&&d==29&&y==2014)
		r=[" Aug 29, "+y+" \n Vinayaka Chavithi! ",gsAction,"skyblue","red"];
	else if (m==10&&d==2&&y==2014)
		r=[" Oct 2, "+y+" \n Gandhi Jayanthi! ",gsAction,"skyblue","red"];
   else if (m==10&&d==3&&y==2014)
		r=[" Oct 3, "+y+" \n Dussehra! ",gsAction,"skyblue","red"];
   else if (m==10&&d==23&&y==2014)
		r=[" Oct 23, "+y+" \n Diwali! ",gsAction,"skyblue","red"];
	else if (m==12&&d==25&&y==2014)
