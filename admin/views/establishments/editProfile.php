...
?>
<form action="<?php echo BASE_ADMIN_URL;?>establishments/editProfile" enctype="multipart/form-data" name="profile" id="profile" method="post">
<div id="EditProfilePopup" class="pro_window login_area btmpadding ">
  <div class="login_inner">
    ...
    <img src="<?php echo BASE_ADMIN_URL.$profile[0]['picture']; ?>" alt="Profile Preview" width="100">
    <?php }else{ ?>
