            ...
            $("tfoot th").each(function(i) {			
                if ((i >= 3 && i <= 4) || i==6) {				
                   /* this.innerHTML = fnCreateSelect(oTable.fnGetColumnData(i));
					...
					this.innerHTML = "<input type='text' id ="+i+" class='search_init'>";
                }
                else {
					/*if(i==0)
					{
        ...
        <section class="table-topbar">
        	...
        	<div class="wrapper-910">
            	<div class="table-buttons">
                   <a href="add" class="fancybox fancybox.ajax"><input type="button" value="Add Establishment" class="btn-input btn-add-establisment"></a>
                    <select name="" class="btn-select btn-export" onChange="coming();" >
                      <option selected>Export</option></a>
                        <option>Excel</option>
                        <option>PDF</option>
                  </select>                    
			...
			?>
              <tr class="even_gradeC <?php echo $class; ?>">
                  <td align="center" width="20px"><input type="checkbox" value="<?php echo $estblish['est_id']; ?>" name="check17"></td>
                ...
                <!--  <td valign="middle"><?php //echo  wordwrap(@$estblish['street1'], 25, "<br />\n"); ?></td>
                  ...
                  <td><a href="editEst/<?php echo $estblish['est_id']; ?>" class="fancybox fancybox.ajax"><img src="../includes/img/edit.png" width="18px" title="View/Edit"></a>
                  <a href="comingsoon" class="fancybox fancybox.ajax"><img src="../includes/img/school.png" width="18px" title="Go To School" alt="Go To School"></a>
                  </td>
                </tr>
            <?php endforeach; ?>    
              </tbody>
