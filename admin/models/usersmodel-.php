...
class UsersModel extends Model
{
	...
	public function insertUser($first_name,$last_name,$email,$establishment_id,$city,$phone,$address,$state,$zipcode,$picture,$user_id,$status)
	{		
	...
	public function editUser($first_name,$last_name,$email,$establishment_id,$city,$phone,$address,$state,$zipcode,$picture,$user_id,$id,$profile_id,$status)	
	{			
		...
		if($picture!=''){
		    echo $sql_pic="UPDATE profiles SET picture='$picture' WHERE id = $profile_id";
